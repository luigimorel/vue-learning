    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
        ...
        <p class="text-gray-500 sm:text-xl">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur cumque expedita voluptates fugit magnam
          dicta dolor, tenetur ipsam deleniti ducimus?
        </p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
        <div>
          <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
            <svg
              class="w-5 h-5 text-lime-600 lg:w-6 lg:h-6"
              fill="currentColor"
              viewBox="0 0 20 20"
        ...
        <div>
          ...
          <p class="text-gray-500">
            Keep your company’s lights on with customizable, iterative, and structured workflows built for all efficient
